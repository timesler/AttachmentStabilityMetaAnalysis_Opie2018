...
data$A.NotA.4 <- rowSums(dataNum[, c("A.B.4", "A.C.4", "A.D.4")])
...
file <- "Output/CONT/AA_Results.csv"
fileFig <- "Output/CONT/AA_Results_figure.csv"
write.table(
  "AA Transitions Tables", 
  file = file, 
  row.names = F, 
  col.names = F, 
  sep = ","
