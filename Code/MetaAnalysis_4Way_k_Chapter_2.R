...
Summary.RVE(
  RVEModel,
  fileName = "Output/StatisticalResults_4way_k_Ch2.txt"
)
...
forest.RVE(
  ...
  fileName = "Figures/4way_k_Forest_Ch2.tiff"
) 

funnel.RVE(
  RVEModel,
  fileName = "Figures/4way_k_Funnel_Ch2.tiff",
  trimnfill = T,
  plotReg = T
)
...
save(correlations, file = "Output/STAB/4-way/Correlations_Ch2.RData")
